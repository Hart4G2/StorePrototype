...
public class UpgradeItem implements Disposable {
    ...
    public UpgradeItem(String imagePath, String name, String description, String buttonText, Event upgradeEvent) {
        ...
        buyButton.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                SimplePublisher.getPublisher().publish(upgradeEvent);
