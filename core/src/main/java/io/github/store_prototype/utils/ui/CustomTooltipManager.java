...
public class CustomTooltipManager {
    static private CustomTooltipManager instance;
    ...
    final Array<CustomToolTip> shown = new Array();
    ...
    public void touchDown (CustomToolTip tooltip) {
        showTask.cancel();
    ...
    public void enter (CustomToolTip tooltip) {
        showTooltip = tooltip;
        showTask.cancel();
        if (enabled || tooltip.always) {
    ...
    public void hide (CustomToolTip tooltip) {
        showTooltip = null;
        showTask.cancel();
    ...
    protected void showAction (CustomToolTip tooltip) {
    ...
    protected void hideAction (CustomToolTip tooltip) {
        tooltip.container
    ...
    public void hideAll () {
        ...
        for (CustomToolTip tooltip : shown)
            tooltip.hide();
        shown.clear();
    }
    ...
    static public CustomTooltipManager getInstance () {
